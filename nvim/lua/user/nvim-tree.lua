...
local function on_attach(bufnr)
  ...
  vim.keymap.set('n', '<CR>', api.node.open.edit, opts('Open'))
  vim.keymap.set('n', 'k', api.node.open.edit, opts('Open'))
  vim.keymap.set('n', '<2-LeftMouse>', api.node.open.edit, opts('Open'))
  vim.keymap.set('n', '<C-l>', api.node.open.replace_tree_buffer, opts('Open: In Place'))
  vim.keymap.set('n', 'K', api.node.open.no_window_picker, opts('Open: No Window Picker'))
  ...
  vim.keymap.set('n', 'N', api.tree.toggle_hidden_filter, opts('Toggle Dotfiles'))
